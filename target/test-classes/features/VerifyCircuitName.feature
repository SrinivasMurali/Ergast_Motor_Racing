...
Feature: Verify the circuit name and it's location details
  ...
  Scenario Outline: Verify circuit of the americas's location details are as expected
    ...
    Then Verify latitude of the circuite "<latitude>"
    Then Verify langitude of the circuite "<langitude>"
    Then Verify loacality of the circuite "<locality>"
    Then Verify country of the circuite "<country>"
